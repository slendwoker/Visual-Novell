...
define config.name = _("A plague of the shadow")
...
define gui.about = _p("""В эту игру вложили много сил.
Эта история расскажет о парне, которому не повезло родиться в эпоху чумы. Ему предстоит спасти свою подругу Кару, которая подверглась заражению.
Чтобы спасти, ему нужно найти легендарный манускрипт "Книга Огненных Звезд". Но путь этот будет не простой, для достижения цели он познакномиться с множеством персонажей, которые помогут ему в поисках.
""")
...
define build.name = "Aplagueoftheshadow"
...
define config.main_menu_music = "music/Variant1.mp3"
...
define config.save_directory = "Aplagueoftheshadow-1707144411"
