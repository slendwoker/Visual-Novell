...
define chel1 = Character('Неизвестный', color="#17587e")
...
label magaz:
    ...
    chel1 "Да его ничего не спасет уже."
    
    "..."
    chel "Не знаешь за сколько стражников на воротах подкупить можно?"
    
    chel1 "Если б знал, ноги б моей тут не было."
...
label street2:
    ...
    oda "Как же мальчик громко кричит. Ему прилетело за то, что он попытался украсть хлеб у торговца."
    menu:
        "Чтобы сделать"
